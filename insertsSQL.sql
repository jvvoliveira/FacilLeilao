...
INSERT INTO TB_ANUNCIO (id, descricao, finalizado, is_active, nome, prazo, valor_base, id_categoria, id_usuario) 
VALUES (2, 'guitarra stratocaster seminova modelo 2', 'false', 1, 'guitarra', '2020-10-30T16:00:00', 800, 2, 2);

INSERT INTO TB_ANUNCIO (id, descricao, finalizado, is_active, nome, prazo, valor_base, id_categoria, id_usuario) 
VALUES (3, 'Honda Civic modelo 2020, banco de couro, direção hidráulica', 'false', 1, 'Honda Civic', '2020-10-30T16:00:00', 100000, 3, 1);

INSERT INTO TB_ANUNCIO (id, descricao, finalizado, is_active, nome, prazo, valor_base, id_categoria, id_usuario) 
VALUES (4, 'Notebook lenovo ideapad320 com SSD', 'false', 1, 'Notebook lenovo', '2020-10-27T12:00:00', 2000, 1, 1);

INSERT INTO TB_ANUNCIO (id, descricao, finalizado, is_active, nome, prazo, valor_base, id_categoria, id_usuario) 
VALUES (5, 'Note 7 preto com capa e películo 64GB', 'false', 1, 'Xiaomi Redmi Note 7', '2020-10-28T13:00:00', 1000, 1, 1);
